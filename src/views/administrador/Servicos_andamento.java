 ...
 * @author Italo
 */
public class Servicos_andamento extends javax.swing.JFrame {
    ...
    public void readJTable() {
        ...
        for (Servico s : servicodao.listarServicos()) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Serviços em andamento");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Número Solicitação", "Cliente", "Telefone", "Data", "Endereço", "Funcionário"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Servicos_andamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Servicos_andamento().setVisible(true);
            }
        });
    }
